...
folder_path = "/projects/img/GAN_CP/PAPER_3/Palette-Image-to-Image-Diffusion-Models-main/Actives_Plate_A/Ground_Truth/"

x0train = pd.read_csv(f'/projects/img/GAN_CP/PAPER_3/src/target2_SET_A_test_general_actives.csv')
#x0DMSO = pd.read_csv(f'/projects/img/GAN_CP/PAPER_3/src/target2_SET1_CONTROLS.csv')

model_evaluating = "SETA_ACTIVES"
#
#"Set 2 Evaluation"
#
...
pixel_cutoff = 15
num_classes = 59 # number of targets
